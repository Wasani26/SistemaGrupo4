...
$app->leer_museo("museo/{$params[1]}/"); //metodo para ver a todos los usuarios
$app->ver_museos("museo/"); //trae información de un solo usuario
$app->actualizar_museo("museo/{$params[1]}/");//metodo para actualizar la contraseñacambiar_contrasena
$app->eliminar_museo("museo/{$params[1]}/");
